local broadcastTexts = {
    HRMT = { -- Station
        ...
        body = {
            ...
            late = {
                late_body_1 = {
                    {text = "Funny thing about silence, folks—it starts to echo after a while.", char = "joshua"},
                    {text = "You’d think silence would be quiet, but nope. It’s got a sound all its own.", char = "joshua"},
                    {text = "Sometimes I swear I hear footsteps out by the shack. Probably just the wind.", char = "joshua"},
                    {text = "Or maybe it’s me pacing in my head.", char = "joshua"},
                    {text = "Either way, I’m still here. Broadcasting, breathing, or something close to it.", char = "joshua"},
                },
                late_body_2 = {
                    {text = "I was cooking some soup earlier and caught myself setting a second bowl.", char = "joshua"},
                    {text = "Force of habit, I guess. Old muscle memory.", char = "joshua"},
                    {text = "Anyway, no sense letting good food go cold. I drank both.", char = "joshua"},
                    {text = "If you’re out there hungry tonight, I hope you’ve got something warm too.", char = "joshua"},
                },
                late_body_3 = {
                    {text = "Some nights I talk to myself just to hear a voice.", char = "joshua"},
                    {text = "Used to do that back in the hippie days too, but back then it was just philosophy.", char = "joshua"},
                    {text = "Now it’s survival.", char = "joshua"},
                    {text = "Well… philosophy and survival aren’t so different, are they?", char = "joshua"},
                },
                late_body_4 = {
                    {text = "I left the radio on after the broadcast yesterday.", char = "joshua"},
                    {text = "Swore I heard someone breathing through the static.", char = "joshua"},
                    {text = "Might’ve just been me. Might’ve been someone else.", char = "joshua"},
                    {text = "Or maybe it was my own echo, coming back late.", char = "joshua"},
                },
                late_body_5 = {
                    {text = "I miss music halls, folks.", char = "joshua"},
                    {text = "The sound of people clapping, feet on old wooden floors.", char = "joshua"},
                    {text = "These days, it’s just me and the wind applause outside.", char = "joshua"},
                },
                late_body_6 = {
                    {text = "You know, sometimes I get this feeling like I left the oven on back in West Point.", char = "joshua"},
                    {text = "Of course, that apartment’s long gone now.", char = "joshua"},
                    {text = "But the mind’s funny like that. Always circling back to the ordinary.", char = "joshua"},
                },
                late_body_7 = {
                    {text = "I keep seeing my wife in the corner of my eye.", char = "joshua"},
                    {text = "Just little flashes—a hand moving, her old sweater.", char = "joshua"},
                    {text = "I know she’s not there. But it’s nice to pretend for a second.", char = "joshua"},
                },
                late_body_8 = {
                    {text = "Some folks talk about surviving day by day.", char = "joshua"},
                    {text = "Me? Lately it feels like minute by minute.", char = "joshua"},
                    {text = "But hey, minutes stack up, just like firewood.", char = "joshua"},
                },
                late_body_9 = {
                    {text = "Sometimes I think about walking out of this shack for good.", char = "joshua"},
                    {text = "Just heading into the woods and letting nature sort it out.", char = "joshua"},
                    {text = "But then who’d do the weather?", char = "joshua"},
                    {text = "Guess I’m stuck here with you folks. Hope you don’t mind.", char = "joshua"},
                },
                late_body_10 = {
                    {text = "Had a dream last night that the world was alive again.", char = "joshua"},
                    {text = "No rot, no boarded windows, just grass underfoot and music in the air.", char = "joshua"},
                    {text = "I woke up holding my breath.", char = "joshua"},
                },
                late_body_11 = {
                    {text = "I caught myself humming today and scared myself half to death.", char = "joshua"},
                    {text = "Forgot what my own voice sounded like without the microphone.", char = "joshua"},
                    {text = "Funny how fast you forget normal.", char = "joshua"},
                },
                late_body_12 = {
                    {text = "I used to read weather charts, satellite data, all that stuff.", char = "joshua"},
                    {text = "Now I just look at the sky and guess.", char = "joshua"},
                    {text = "And honestly? Sometimes that feels more honest.", char = "joshua"},
                },
                late_body_13 = {
                    {text = "Sometimes I wonder if there’s anyone left to listen.", char = "joshua"},
                    {text = "Then I figure, well—someone’s gotta be talking, or the world’s just static.", char = "joshua"},
                    {text = "So here I am, keeping the words moving.", char = "joshua"},
                },
                late_body_14 = {
                    {text = "I had this idea once—after all this, we’d rebuild.", char = "joshua"},
                    {text = "Start over. Clean slate.", char = "joshua"},
                    {text = "But these days? I don’t know. Maybe the trees get the second chance instead.", char = "joshua"},
                },
                late_body_15 = {
                    {text = "Sometimes I sit here and shuffle my old tarot cards.", char = "joshua"},
                    {text = "Last night I pulled The Hermit three times in a row.", char = "joshua"},
                    {text = "Can’t tell if that’s fate or just a worn-out deck.", char = "joshua"},
                },
                late_body_16 = {
                    {text = "The wind knocked over my lantern today.", char = "joshua"},
                    {text = "For a second, I thought it was my wife coming in the door.", char = "joshua"},
                    {text = "It wasn’t. But I still looked anyway.", char = "joshua"},
                },
                late_body_17 = {
                    {text = "People used to say 'see you tomorrow' like it was a given.", char = "joshua"},
                    {text = "Now it feels like a promise I can’t always keep.", char = "joshua"},
                    {text = "But I’m still here. Talking. Hoping.", char = "joshua"},
                },
                late_body_18 = {
                    {text = "Funny how the brain pulls tricks on you when you’re alone.", char = "joshua"},
                    {text = "Last night I thought I heard the old dusty telephone on the shelf ring.", char = "joshua"},
                    {text = "Haven’t had a landline in years, but still—I reached for it.", char = "joshua"},
                },
                late_body_19 = {
                    {text = "Sometimes I forget what day it is.", char = "joshua"},
                    {text = "But then again, maybe that’s a good thing.", char = "joshua"},
                    {text = "Days can’t hurt you if you stop counting them.", char = "joshua"},
                },
                late_body_20 = {
                    {text = "I cleaned out the corner of the shack today. Found one of my wife’s old scarves.", char = "joshua"},
                    {text = "Still smelled like lavender. Or maybe I imagined that part.", char = "joshua"},
                    {text = "I wrapped it around the microphone for a bit. Felt like sharing the air.", char = "joshua"},
                },
                late_body_21 = {
                    {text = "Sometimes the wind rattles the boards on the shack, and it sounds just like a door trying to open.", char = "joshua"},
                    {text = "Makes my heart jump every time.", char = "joshua"},
                    {text = "Funny how some doors stay shut, huh?", char = "joshua"},
                    {text = "Well… anyway. I’m still here, folks.", char = "joshua"},
                },
                late_body_22 = {
                    {text = "I keep thinking I should check the bedroom back in West Point.", char = "joshua"},
                    {text = "Maybe she's still there, standing, staring at the wall.", char = "joshua"},
                    {text = "But it’s a long way from here now.", char = "joshua"},
                    {text = "Some doors you just don’t open twice.", char = "joshua"},
                },
                late_body_23 = {
                    {text = "I had a dream last night that I heard my lady's voice calling me from down the hall.", char = "joshua"},
                    {text = "Woke up halfway to the door before I remembered where I was.", char = "joshua"},
                    {text = "Guess the mind’s got its own loops to run.", char = "joshua"},
                },
                late_body_24 = {
                    {text = "There’s this part of me that keeps thinking I’ll go back one day.", char = "joshua"},
                    {text = "Back to West Point. Back to that apartment.", char = "joshua"},
                    {text = "But I know better. Some places you leave behind on purpose.", char = "joshua"},
                },
                late_body_25 = {
                    {text = "Sometimes I hear my wife humming. Just soft, in the back of my mind.", char = "joshua"},
                    {text = "Used to be she’d do that while cooking.", char = "joshua"},
                    {text = "Now it’s just me and canned stuff.", char = "joshua"},
                },
                late_body_26 = {
                    {text = "I keep thinking I should’ve… done something different.", char = "joshua"},
                    {text = "But I didn’t. And here I am, talking into a radio.", char = "joshua"},
                    {text = "Some choices echo louder than others.", char = "joshua"},
                },
                late_body_27 = {
                    {text = "Locked doors have a way of staying with you.", char = "joshua"},
                    {text = "Even when you’re miles away, sometimes you still hear the latch.", char = "joshua"},
                    {text = "Funny, huh?", char = "joshua"},
                },
                late_body_28 = {
                    {text = "You ever leave something behind and pretend it’s still fine?", char = "joshua"},
                    {text = "That’s a trick I’ve learned too well.", char = "joshua"},
                    {text = "Anyway, folks—still here, still talking.", char = "joshua"},
                },
                late_body_29 = {
                    {text = "I keep thinking I’ll hear my wife's footsteps again.", char = "joshua"},
                    {text = "Just once more. Just to know she’s close.", char = "joshua"},
                    {text = "But the shack stays quiet.", char = "joshua"},
                },
                late_body_30 = {
                    {text = "Sometimes I practice what I’d say if I saw her again.", char = "joshua"},
                    {text = "Never get past the first few words.", char = "joshua"},
                    {text = "Maybe that’s for the best.", char = "joshua"},
                },
                late_body_31 = {
                    {text = "I still see her face when I close my eyes at night.", char = "joshua"},
                    {text = "Sometimes she’s smiling. Sometimes she’s not.", char = "joshua"},
                    {text = "Funny how memory plays both sides of the tape.", char = "joshua"},
                },
                late_body_32 = {
                    {text = "I found one of my wife's old notes tucked in my notebook.", char = "joshua"},
                    {text = "Just said: 'Don’t forget to breathe.'", char = "joshua"},
                    {text = "Guess I’m still doing that part, at least.", char = "joshua"},
                },
                late_body_33 = {
                    {text = "You know, I used to be real good at fixing things.", char = "joshua"},
                    {text = "Radios, batteries, old weather equipment.", char = "joshua"},
                    {text = "People? Not so much.", char = "joshua"},
                },
                late_body_34 = {
                    {text = "Sometimes when I’m half asleep, I hear her say my name.", char = "joshua"},
                    {text = "Real soft. Like she used to when she needed help with the garden.", char = "joshua"},
                    {text = "There’s no garden here, but I still listen.", char = "joshua"},
                },
                late_body_35 = {
                    {text = "I left a light on in the shack tonight.", char = "joshua"},
                    {text = "Maybe she’ll find her way home. Maybe not.", char = "joshua"},
                    {text = "Either way, the light stays on.", char = "joshua"},
                },
                late_body_36 = {
                    {text = "Funny thing about survival, folks—it doesn’t come with instructions.", char = "joshua"},
                    {text = "I’ve got manuals for everything else. Radios, weather patterns.", char = "joshua"},
                    {text = "Not for this part, though.", char = "joshua"},
                },
                late_body_37 = {
                    {text = "I still set two cups out sometimes. Coffee’s just habit.", char = "joshua"},
                    {text = "I pour them, then drink both. Waste not, right?", char = "joshua"},
                },
                late_body_38 = {
                    {text = "The nights get longer when you’re alone.", char = "joshua"},
                    {text = "Long enough to remember all the things you didn’t do.", char = "joshua"},
                    {text = "Long enough to think about the bedroom door you didn’t open again.", char = "joshua"},
                },
                late_body_39 = {
                    {text = "Sometimes I wonder if she forgave me.", char = "joshua"},
                    {text = "I like to think she did. That she still can do that in her... condition.", char = "joshua"},
                    {text = "But that’s thoughts while sitting here with weather equipment.", char = "joshua"},
                },
                late_body_40 = {
                    {text = "There’s a lot of things I’ll never say out loud.", char = "joshua"},
                    {text = "But Martha, if you’re listening, wherever you are…", char = "joshua"},
                    {text = "I’m sorry.", char = "joshua"},
                },
                late_body_41 = {
                    {text = "Alright folks, tonight’s wisdom isn’t about carpentry or fishing—it’s about staying sane.", char = "joshua"},
                    {text = "First thing: breathe. Sounds simple, right?", char = "joshua"},
                    {text = "But when you’re locked up somewhere, your mind races. It loops.", char = "joshua"},
                    {text = "So stop for a minute. Sit still. Take three deep breaths. In through the nose, out through the mouth.", char = "joshua", effect = "UHP-1"},
                    {text = "Don’t fix the world right now. Just fix the moment.", char = "joshua"},
                    {text = "You’re still here. That’s step one.", char = "joshua"},
                },
                late_body_42 = {
                    {text = "Loneliness is like cold weather—it sneaks up on you if you’re not paying attention.", char = "joshua"},
                    {text = "Talk to someone if you can. If you can’t? Talk to yourself. Talk to me. I’m here.", char = "joshua"},
                    {text = "Keeping words flowing keeps the mind moving.", char = "joshua"},
                    {text = "And hey, if you feel silly talking out loud? Good. That means you’re still human.", char = "joshua", effect = "UHP-1"},
                    {text = "Better silly than silent.", char = "joshua"},
                },
                late_body_43 = {
                    {text = "One thing I’ve learned from this mess—we need little rituals.", char = "joshua"},
                    {text = "Doesn’t have to be fancy. Could be lighting a candle. Could be winding a watch that doesn’t work.", char = "joshua"},
                    {text = "Rituals remind you that time still exists. That you’re still part of something.", char = "joshua", effect = "UHP-1"},
                    {text = "Even if it’s just part of the static.", char = "joshua"},
                },
                late_body_44 = {
                    {text = "If you’re feeling stuck, try moving something small.", char = "joshua"},
                    {text = "Stack your canned food. Rearrange some books. Clean a corner of your shelter.", char = "joshua"},
                    {text = "Order outside makes order inside, even when the world’s falling apart.", char = "joshua", effect = "UHP-1"},
                    {text = "It’s not magic, but it helps.", char = "joshua"},
                },
                late_body_45 = {
                    {text = "Here’s a trick I learned during the old days of weather stations.", char = "joshua"},
                    {text = "When the equipment breaks down, don’t panic. Focus on what still works.", char = "joshua"},
                    {text = "Same goes for your mind.", char = "joshua"},
                    {text = "You’re tired? Okay. But you’re still breathing. Your hands still work. Your heart’s still in there.", char = "joshua", effect = "UHP-1"},
                    {text = "Start with what’s working. Build from there.", char = "joshua"},
                },
                late_body_46 = {
                    {text = "They used to say 'don’t sweat the small stuff.'", char = "joshua"},
                    {text = "But out here, the small stuff keeps you sane.", char = "joshua"},
                    {text = "Notice the sound of the wind. Watch how the leaves move. Feel your heartbeat.", char = "joshua", effect = "UHP-1"},
                    {text = "When the big things fall apart, the small things keep you grounded.", char = "joshua"},
                },
                late_body_47 = {
                    {text = "If your thoughts get too loud, try writing them down.", char = "joshua"},
                    {text = "Doesn’t have to be pretty. Just scribble in a notebook, on a wall, in the dirt if you have to.", char = "joshua", effect = "UHP-1"},
                    {text = "Writing lets you park thoughts somewhere safe so you can breathe again.", char = "joshua"},
                    {text = "Even if you burn the paper after, it still helps.", char = "joshua"},
                },
                late_body_48 = {
                    {text = "You know what helps on hard nights? Talking to the sky.", char = "joshua"},
                    {text = "Doesn’t matter if it answers back. It probably won’t.", char = "joshua"},
                    {text = "But saying things out loud helps you carry them better.", char = "joshua", effect = "UHP-1"},
                    {text = "Try it sometime. Whisper to the stars. They’re good listeners.", char = "joshua"},
                },
                late_body_49 = {
                    {text = "Folks, if you’re feeling heavy, try moving slow on purpose.", char = "joshua"},
                    {text = "Make a cup of tea like it’s a ceremony. Fold your blanket like you’re practicing meditation.", char = "joshua"},
                    {text = "When you move slow, the world slows down too.", char = "joshua"},
                    {text = "And right now, slower’s safer.", char = "joshua", effect = "UHP-1"},
                },
                late_body_50 = {
                    {text = "Some folks think being tough means ignoring feelings.", char = "joshua"},
                    {text = "I say it’s the opposite. Let yourself feel stuff—then keep going anyway.", char = "joshua"},
                    {text = "That’s real strength.", char = "joshua"},
                    {text = "And if you can’t keep going right now? That’s okay too.", char = "joshua", effect = "UHP-1"},
                },
                late_body_51 = {
                    {text = "Night’s when the bad thoughts come knocking, huh?", char = "joshua"},
                    {text = "I get it. Believe me, I do.", char = "joshua"},
                    {text = "But here’s the thing—the sun’s still gonna rise tomorrow.", char = "joshua"},
                    {text = "Might as well be around to see it.", char = "joshua", effect = "UHP-1"},
                },
                late_body_52 = {
                    {text = "If you find yourself staring at the wall too long, change your angle.", char = "joshua"},
                    {text = "Sit on the floor. Look out a different window.", char = "joshua"},
                    {text = "Sometimes the mind just needs a new view, even if it’s the same room.", char = "joshua", effect = "UHP-1"},
                },
                late_body_53 = {
                    {text = "Don’t forget to eat, folks.", char = "joshua"},
                    {text = "I know it sounds silly, but it’s easy to skip meals when the world’s gone sideways.", char = "joshua"},
                    {text = "Food keeps you going. So does water. So does rest.", char = "joshua"},
                    {text = "Take care of the basics. The rest follows.", char = "joshua", effect = "UHP-1"},
                },
                late_body_54 = {
                    {text = "Some days you won’t feel like talking. That’s alright.", char = "joshua"},
                    {text = "But don’t shut down completely. Let the air out slow, like a kettle cooling down.", char = "joshua"},
                    {text = "If you don’t let it out, it’ll find its own way—and that usually ain’t good.", char = "joshua", effect = "UHP-1"},
                },
                late_body_55 = {
                    {text = "Here’s one for the folks listening in the dark.", char = "joshua"},
                    {text = "If you’re scared right now, that’s okay. Fear means you’re still alive.", char = "joshua"},
                    {text = "Just don’t let it boss you around.", char = "joshua"},
                    {text = "Take a breath. Then take another step.", char = "joshua", effect = "UHP-1"},
                },
                late_body_56 = {
                    {text = "Ever notice how the mind plays tricks when you’re tired?", char = "joshua"},
                    {text = "Things feel heavier than they are. Shadows look bigger.", char = "joshua"},
                    {text = "Try sleeping on it before you panic.", char = "joshua"},
                    {text = "The monsters shrink in the morning light.", char = "joshua", effect = "UHP-1"},
                },
                late_body_57 = {
                    {text = "Some of you might be feeling stuck right now.", char = "joshua"},
                    {text = "Like nothing’s moving. Like you’re trapped in syrup.", char = "joshua"},
                    {text = "That’s okay. Just keep breathing.", char = "joshua"},
                    {text = "Even standing still is surviving.", char = "joshua", effect = "UHP-1"},
                },
                late_body_58 = {
                    {text = "It’s alright to miss things, folks.", char = "joshua"},
                    {text = "Old routines, old friends, heck—even the smell of gas stations.", char = "joshua"},
                    {text = "Missing stuff is part of being human.", char = "joshua"},
                    {text = "Just don’t let the missing take away the living.", char = "joshua", effect = "UHP-1"},
                },
                late_body_59 = {
                    {text = "There’s no shame in talking to the walls, folks.", char = "joshua"},
                    {text = "Or the radio. Or the raccoons.", char = "joshua"},
                    {text = "We’re social creatures, even now.", char = "joshua"},
                    {text = "So talk. Make noise. Keep the world going. But try to do so not too loud, alright?", char = "joshua", effect = "UHP-1"},
                },
                late_body_60 = {
                    {text = "Sometimes I sit here thinking about all the stuff I can’t fix.", char = "joshua"},
                    {text = "Then I remind myself—small steps, Joshua. Small steps.", char = "joshua"},
                    {text = "Same goes for you out there.", char = "joshua"},
                    {text = "Fix one little thing today. That’s enough.", char = "joshua"},
                },
                late_body_61 = {
                    {text = "Alright folks, let’s talk about fishing for a bit.", char = "joshua"},
                    {text = "If you’ve got a rod, great. If not, a stick and some line can do in a pinch.", char = "joshua"},
                    {text = "Don’t forget—hooks aren’t fancy things. A bent nail works just fine.", char = "joshua", effect = "FIS+1"},
                    {text = "Bait’s easy, too. Worms under rocks, crickets in the grass.", char = "joshua"},
                    {text = "Fish don’t care about brands. They care about food.", char = "joshua"},
                },
                late_body_62 = {
                    {text = "Fishing’s a patience game, folks. Especially now.", char = "joshua"},
                    {text = "Cast out, then let the line sit still. Fish don’t like nervous hands.", char = "joshua"},
                    {text = "If the bobber twitches? Give it a second. Let the fish commit.", char = "joshua", effect = "FIS+1"},
                    {text = "Yank too soon and you’ll just scare ‘em off.", char = "joshua"},
                    {text = "Timing’s everything. Like life, huh?", char = "joshua"},
                },
                late_body_63 = {
                    {text = "Sometimes you won’t catch anything. That’s just how it goes.", char = "joshua"},
                    {text = "But don’t give up. Try different spots.", char = "joshua"},
                    {text = "Deep water for bigger fish, shallow water for quick bites.", char = "joshua", effect = "FIS+1"},
                    {text = "Morning and dusk are your best times.", char = "joshua"},
                    {text = "Fish get lazy when it’s too hot or too cold—can’t blame ‘em.", char = "joshua"},
                },
                late_body_64 = {
                    {text = "Fishing line’s gonna snap sometimes. That’s just life.", char = "joshua"},
                    {text = "Keep extra line if you’ve got it. If not, try braided thread or twine.", char = "joshua"},
                    {text = "I’ve even used dental floss once. Worked fine.", char = "joshua", effect = "FIS+1"},
                    {text = "Point is—improvise, don’t panic.", char = "joshua"},
                },
                late_body_65 = {
                    {text = "Some folks think fishing’s about luck.", char = "joshua"},
                    {text = "It ain’t. It’s about paying attention.", char = "joshua"},
                    {text = "Watch the water. Look for ripples, small swirls—that’s where they are.", char = "joshua", effect = "FIS+1"},
                    {text = "Fish tell you where they’re hiding if you listen close enough.", char = "joshua"},
                },
                late_body_66 = {
                    {text = "Let’s talk about cleaning your catch.", char = "joshua"},
                    {text = "Small knife, careful hands. Slice the belly from tail to head.", char = "joshua"},
                    {text = "Pull the guts out in one smooth motion if you can.", char = "joshua", effect = "COO+1"},
                    {text = "Rinse with clean water, not river water if you can help it.", char = "joshua"},
                    {text = "Leave the head on or off—that’s up to you.", char = "joshua"},
                },
                late_body_67 = {
                    {text = "If you’ve got no rod, try trapping fish instead.", char = "joshua"},
                    {text = "Rock pools, small creeks—build a V-shaped wall of stones.", char = "joshua"},
                    {text = "When the fish swim in, they get stuck in the corner.", char = "joshua", effect = "FIS+1"},
                    {text = "Simple trick. Works better than you’d think.", char = "joshua"},
                },
                late_body_68 = {
                    {text = "Some folks like fancy bait, but plain ol’ bread works just fine.", char = "joshua", effect = "FIS+1"},
                    {text = "If you’ve got flour and water, mash it into dough and ball it up.", char = "joshua"},
                    {text = "Fish aren’t picky when they’re hungry.", char = "joshua"},
                    {text = "Sometimes I think that’s something people forget.", char = "joshua"},
                },
                late_body_69 = {
                    {text = "Catch and release? That ain’t the time for that anymore.", char = "joshua"},
                    {text = "If you catch something, cook it. Eat it. Share if you can.", char = "joshua", effect = "FIS+1"},
                    {text = "I don’t like killing things, but survival makes its own rules.", char = "joshua"},
                    {text = "Don't forget to thank the fish. Then feed yourself.", char = "joshua"},
                },
                late_body_70 = {
                    {text = "A tip, friends—don’t fish too long in one spot.", char = "joshua", effect = "FIS+1"},
                    {text = "Fish learn. If they stop biting, move downstream or try a different pond.", char = "joshua"},
                    {text = "Nature’s got its patterns. Learn ‘em and you’ll eat better.", char = "joshua"},
                    {text = "I’ve been living off rivers longer than I care to count.", char = "joshua"},
                },
                late_body_71 = {
                    {text = "Fishing at night works too, folks. But it’s trickier.", char = "joshua"},
                    {text = "Some fish like the dark, but you won’t see your bobber much.", char = "joshua"},
                    {text = "Try tying something light-colored near the line tip so you can spot movement.", char = "joshua", effect = "FIS+1"},
                    {text = "Or close your eyes and listen for splashes. Sound works better than sight sometimes.", char = "joshua"},
                    {text = "Just watch your footing near the water’s edge, especially in the dark.", char = "joshua"},
                },
                late_body_72 = {
                    {text = "When you gut a fish, don’t throw the leftovers near your camp.", char = "joshua"},
                    {text = "Critters will come looking for scraps.", char = "joshua"},
                    {text = "Coyotes, raccoons, maybe worse.", char = "joshua"},
                    {text = "Bury the guts away from where you sleep. Keeps you safer.", char = "joshua"},
                    {text = "And yeah, bury ‘em deep. Raccoons are clever little diggers.", char = "joshua"},
                },
                late_body_73 = {
                    {text = "If you don’t have bait, try cutting a small piece of fish you already caught.", char = "joshua", effect = "FIS+1"},
                    {text = "Fish are weird like that—they’ll eat their own kind sometimes.", char = "joshua"},
                    {text = "Especially if you’re after catfish or bass.", char = "joshua", effect = "FIS+1"},
                    {text = "Circle of life, huh?", char = "joshua"},
                },
                late_body_74 = {
                    {text = "You can’t eat bones, but you can use ‘em.", char = "joshua"},
                    {text = "Fish bones make decent hooks if you clean and sharpen ‘em right.", char = "joshua"},
                    {text = "Grind the end to a point, tie it to the line with plant fiber or thread.", char = "joshua", effect = "CRV+1"},
                    {text = "It ain’t perfect, but it works when you’re out of metal hooks.", char = "joshua"},
                },
                late_body_75 = {
                    {text = "If you’re fishing in the rain, that’s actually a good thing.", char = "joshua"},
                    {text = "Rain stirs up the bugs, which brings the fish close to the surface.", char = "joshua", effect = "FIS+1"},
                    {text = "Just make sure you’ve got shelter nearby in case it turns to storm.", char = "joshua"},
                    {text = "Lightning and fishing rods don’t mix, folks.", char = "joshua"},
                },
                late_body_76 = {
                    {text = "About fishing, folks: keep your line dry when you’re not using it.", char = "joshua"},
                    {text = "Wet line left coiled will rot fast, especially if it’s thread or plant fiber.", char = "joshua", effect = "FIS+1"},
                    {text = "Hang it up after fishing. Keeps it ready for next time.", char = "joshua"},
                    {text = "Little things like that save big headaches later.", char = "joshua"},
                },
                late_body_77 = {
                    {text = "Fishing in moving water? Cast upstream, not downstream.", char = "joshua"},
                    {text = "That way your bait drifts naturally with the current.", char = "joshua"},
                    {text = "Fish are more likely to bite if it looks real.", char = "joshua", effect = "FIS+1"},
                    {text = "Makes you look like a pro, even if you’re just guessing.", char = "joshua"},
                },
                late_body_78 = {
                    {text = "When you catch a big one, don’t lift it straight out fast.", char = "joshua"},
                    {text = "Let it tire itself out first or you’ll snap the line.", char = "joshua"},
                    {text = "Keep the rod low, let the fish pull for a bit, then reel in slow.", char = "joshua", effect = "FIS+1"},
                    {text = "Patience is better than strength with fishing.", char = "joshua"},
                },
                late_body_79 = {
                    {text = "Cold days? Fish get sluggish.", char = "joshua"},
                    {text = "They’ll hang near the bottom where the water’s warmer.", char = "joshua"},
                    {text = "Use heavier sinkers if you’ve got ‘em, or let the bait drift down slow.", char = "joshua", effect = "FIS+1"},
                    {text = "Deep water fishing’s tricky, but it pays off when it’s cold.", char = "joshua"},
                },
                late_body_80 = {
                    {text = "Fishing advice: fish scales can be slippery, folks.", char = "joshua"},
                    {text = "If you don’t have gloves, rub a little dirt on your hands for grip.", char = "joshua", effect = "FIS+1"},
                    {text = "Sounds weird, but it works.", char = "joshua"},
                    {text = "Better that than dropping your dinner back into the river.", char = "joshua"},
                },
                late_body_81 = {
                    {text = "Alright folks, let’s talk about growing your own food.", char = "joshua"},
                    {text = "Start with the basics—dig a patch of dirt somewhere it gets sun.", char = "joshua"},
                    {text = "Doesn’t need to be pretty. Nature don’t care about pretty.", char = "joshua"},
                    {text = "Soft soil helps roots breathe, so loosen it up with a stick or shovel.", char = "joshua", effect = "FRM+1"},
                    {text = "Simple as that—good dirt, good sun, and a little patience.", char = "joshua"},
                },
                late_body_82 = {
                    {text = "Seed spacing matters more than folks think.", char = "joshua"},
                    {text = "If you plant too close, the roots fight each other.", char = "joshua", effect = "FRM+1"},
                    {text = "Give ‘em breathing room—think about a hand’s width apart for most crops.", char = "joshua"},
                    {text = "Better to have a few healthy plants than a crowded patch that dies off.", char = "joshua"},
                },
                late_body_83 = {
                    {text = "Watering’s not just about dumping a bucket on the dirt.", char = "joshua"},
                    {text = "Too much water drowns roots. Too little, and they shrivel.", char = "joshua"},
                    {text = "Stick your finger in the dirt. If it’s damp, you’re good.", char = "joshua", effect = "FRM+1"},
                    {text = "If it’s dry past the first knuckle, time to water.", char = "joshua"},
                },
                late_body_84 = {
                    {text = "Rain’s a blessing, but it can wash away seeds if you’re not careful.", char = "joshua"},
                    {text = "Cover your garden with sticks and leaves to slow the runoff.", char = "joshua", effect = "FRM+1"},
                    {text = "Keeps the soil from sliding out with the storm.", char = "joshua"},
                    {text = "Old farmers used to call it nature’s umbrella.", char = "joshua"},
                },
                late_body_85 = {
                    {text = "Worried about bugs? Try planting a few extra herbs near your crops.", char = "joshua", effect = "FRM+1"},
                    {text = "Basil, mint, or onions help keep pests away.", char = "joshua"},
                    {text = "Smells good, too.", char = "joshua"},
                    {text = "Doesn’t mean you won’t get bugs, but it helps slow ‘em down.", char = "joshua"},
                },
                late_body_86 = {
                    {text = "Watch for plant sickness, folks.", char = "joshua"},
                    {text = "If your leaves turn yellow, could be too much water or not enough light.", char = "joshua", effect = "FRM+1"},
                    {text = "Brown spots? Could be a fungus or soil problem.", char = "joshua"},
                    {text = "Pull the sick plants early so they don’t mess up the whole patch.", char = "joshua"},
                },
                late_body_87 = {
                    {text = "Save seeds from good crops, not bad ones.", char = "joshua"},
                    {text = "Pick the strongest plant you got and let it go to seed.", char = "joshua", effect = "FRM+1"},
                    {text = "Dry those seeds out real good before you store ‘em.", char = "joshua"},
                    {text = "That’s how you get better crops next time around.", char = "joshua"},
                },
                late_body_88 = {
                    {text = "Farming’s not just about planting and picking—it’s about timing.", char = "joshua"},
                    {text = "Harvest too soon, you get small crops.", char = "joshua"},
                    {text = "Harvest too late, they rot right on the vine.", char = "joshua", effect = "FRM+1"},
                    {text = "Check your plants every day. Nature won’t send you a reminder.", char = "joshua"},
                },
                late_body_89 = {
                    {text = "Compost helps, even if you’re just piling up old scraps.", char = "joshua"},
                    {text = "Rotten vegetables, eggshells, coffee grounds—mix it into the dirt later.", char = "joshua"},
                    {text = "Gives your soil new life without any fancy tools.", char = "joshua", effect = "FRM+1"},
                    {text = "Nature likes circles, folks. Nothing really goes to waste.", char = "joshua"},
                },
                late_body_90 = {
                    {text = "Sometimes crops fail. That’s just how it goes.", char = "joshua"},
                    {text = "Don’t put all your beans in one patch. Spread out what you plant.", char = "joshua"},
                    {text = "Try a few spots. Different soil, different luck.", char = "joshua", effect = "FRM+1"},
                    {text = "Survival’s about options, not perfection.", char = "joshua"},
                },
                late_body_91 = {
                    {text = "Let’s talk about carving, folks.", char = "joshua"},
                    {text = "Start simple—grab a stick, sit somewhere quiet, and whittle the bark off.", char = "joshua", effect = "CRV+1"},
                    {text = "Doesn’t matter if you make anything useful at first.", char = "joshua"},
                    {text = "You’re learning how the knife feels in your hand.", char = "joshua"},
                    {text = "Control comes before craft.", char = "joshua"},
                },
                late_body_92 = {
                    {text = "Sharp tools are safer than dull ones.", char = "joshua"},
                    {text = "Sounds backward, but it’s true.", char = "joshua"},
                    {text = "A sharp blade cuts clean. A dull one slips and takes your finger with it.", char = "joshua", effect = "CRV+1"},
                    {text = "So keep your knife honed, even if it’s just on the back of a plate.", char = "joshua"},
                },
                late_body_93 = {
                    {text = "Always carve away from yourself.", char = "joshua", effect = "CRV+1"},
                    {text = "Point the blade outward, not toward your body.", char = "joshua"},
                    {text = "Sounds basic, but folks forget when they get in the rhythm.", char = "joshua"},
                    {text = "One slip and you’re patching up more than wood.", char = "joshua"},
                },
                late_body_94 = {
                    {text = "If you’re making a handle or a peg, carve it bigger first.", char = "joshua"},
                    {text = "Better to shave off little bits than try to fix something too small.", char = "joshua", effect = "CRV+1"},
                    {text = "Measure with your eyes, then cut slow.", char = "joshua"},
                    {text = "Small cuts, steady hands—that’s how you get it right.", char = "joshua"},
                },
                late_body_95 = {
                    {text = "Wood choice matters when you’re carving.", char = "joshua"},
                    {text = "Pine’s soft but splits easy. Oak’s tough but wears your knife out.", char = "joshua"},
                    {text = "Try something in between if you can—like maple or birch.", char = "joshua", effect = "CRV+1"},
                    {text = "Use what’s around you. That’s survival.", char = "joshua"},
                },
                late_body_96 = {
                    {text = "When you’re carving, sit somewhere stable.", char = "joshua"},
                    {text = "Don’t do it standing up or in the rain where you’ll slip.", char = "joshua"},
                    {text = "Back against a tree, feet flat on the ground—that’s the way.", char = "joshua", effect = "CRV+1"},
                    {text = "The calmer you sit, the cleaner your work.", char = "joshua"},
                },
                late_body_97 = {
                    {text = "Got extra time? Try carving tools for other jobs.", char = "joshua"},
                    {text = "Tent stakes, fishing floats, sewing needles—you’d be surprised what a stick or a bone can become.", char = "joshua", effect = "CRV+1"},
                    {text = "Everything starts as just material in your hands.", char = "joshua"},
                },
                late_body_98 = {
                    {text = "Carving’s good for the mind, too.", char = "joshua"},
                    {text = "Focuses your thoughts. Slows down the noise upstairs.", char = "joshua"},
                    {text = "That’s why I still do it, even when I don’t need another spoon.", char = "joshua"},
                    {text = "Sometimes your hands know what your head doesn’t.", char = "joshua"},
                },
                late_body_99 = {
                    {text = "When you carve something thin, don’t rush.", char = "joshua"},
                    {text = "Thin pieces break easy if you get impatient.", char = "joshua"},
                    {text = "Better to make three small cuts than one big mistake.", char = "joshua", effect = "CRV+1"},
                    {text = "Take your time. The world’s already broken enough.", char = "joshua"},
                },
                late_body_100 = {
                    {text = "If you mess up while carving, don’t throw the piece away.", char = "joshua"},
                    {text = "Mistakes teach better than successes sometimes.", char = "joshua"},
                    {text = "Keep the scrap wood—you’ll find a use for it later.", char = "joshua"},
                    {text = "Nothing’s really wasted out here.", char = "joshua", effect = "CRV+1"},
                },
                late_body_101 = {
                    {text = "Let’s talk about clay, folks. Real handy stuff if you can find it.", char = "joshua"},
                    {text = "Look near riverbanks or creeks where the soil’s sticky and smooth.", char = "joshua"},
                    {text = "If you can roll it into a coil without it cracking, that’s clay.", char = "joshua", effect = "POT+1"},
                    {text = "Don’t need fancy tools to get started—just your hands and some patience.", char = "joshua"},
                },
                late_body_102 = {
                    {text = "Pottery’s one of the oldest tricks humans ever learned.", char = "joshua"},
                    {text = "Start simple—make a bowl or cup with the pinch method.", char = "joshua"},
                    {text = "Press your thumb into a ball of clay, then pinch the sides out evenly.", char = "joshua", effect = "POT+1"},
                    {text = "Keep the walls thin but not too thin, or it’ll crack in the fire.", char = "joshua"},
                },
                late_body_103 = {
                    {text = "Today's lesson folks: pottery.", char = "joshua"},
                    {text = "Coil pots are a step up from pinching.", char = "joshua"},
                    {text = "Roll clay into long snake shapes and stack ‘em up like rings.", char = "joshua", effect = "POT+1"},
                    {text = "Smooth the sides as you go so it holds together.", char = "joshua"},
                    {text = "That’s how you make jars without a wheel.", char = "joshua"},
                },
                late_body_104 = {
                    {text = "Let's talk business. Pottery one.", char = "joshua"},
                    {text = "Dry your clay slowly before firing it, or it’ll crack.", char = "joshua", effect = "POT+1"},
                    {text = "Leave it in the shade for a couple days if you can.", char = "joshua"},
                    {text = "Too much sun too fast pulls the moisture out uneven.", char = "joshua"},
                    {text = "Patience saves you from starting over.", char = "joshua"},
                },
                late_body_105 = {
                    {text = "Alright, let's talk handmade dishes.", char = "joshua"},
                    {text = "Firing pottery ain’t easy, but it’s doable if you've got a simple furance.", char = "joshua"},
                    {text = "Build a hot fire, let it burn down to coals, then bury your clay pieces in there.", char = "joshua"},
                    {text = "Cover them with more coals and ash to trap the heat.", char = "joshua", effect = "POT+1"},
                    {text = "Don’t rush it—let the fire do its work.", char = "joshua"},
                },
                late_body_106 = {
                    {text = "Next in the menu: pottery advice.", char = "joshua"},
                    {text = "Some clays have too much sand and won’t hold shape well.", char = "joshua"},
                    {text = "You can mix in cleaner clay or sift out the sand if you’ve got the time.", char = "joshua"},
                    {text = "A kitchen strainer works if you’ve still got one.", char = "joshua", effect = "POT+1"},
                    {text = "If not, use your hands. Old-school works fine.", char = "joshua"},
                },
                late_body_107 = {
                    {text = "Let's talk pottery safety, folks.", char = "joshua"},
                    {text = "Make sure your clay’s wedged before you start shaping.", char = "joshua"},
                    {text = "That just means kneading it like dough to get the air bubbles out.", char = "joshua", effect = "POT+1"},
                    {text = "Air pockets make pots explode in the fire.", char = "joshua"},
                    {text = "Trust me—you don’t want that.", char = "joshua"},
                },
                late_body_108 = {
                    {text = "A friendly advice to those of you who like to do your own pottery.", char = "joshua"},
                    {text = "Handles are the tricky part, folks.", char = "joshua"},
                    {text = "Let the pot dry a little before adding them so it’s firm but not hard.", char = "joshua"},
                    {text = "Score the surface where you’re attaching the handle—just scratch it up a bit.", char = "joshua"},
                    {text = "Then press the handle on and smooth the join with wet clay.", char = "joshua", effect = "POT+1"},
                },
                late_body_109 = {
                    {text = "A word about pottery. And common sense.", char = "joshua"},
                    {text = "If you’ve got extra clay, make lids for your pots.", char = "joshua", effect = "POT+1"},
                    {text = "Lids keep bugs out of your food and water.", char = "joshua"},
                    {text = "Even a rough lid works better than nothing.", char = "joshua"},
                    {text = "Survival ain’t about pretty—it’s about practical.", char = "joshua"},
                },
                late_body_110 = {
                    {text = "For those of you who are starting to make your own pots.", char = "joshua"},
                    {text = "Don’t worry if your first pots are lopsided.", char = "joshua"},
                    {text = "Ugly pots still hold beans.", char = "joshua"},
                    {text = "Each time you make one, you’ll get better.", char = "joshua", effect = "POT+1"},
                    {text = "Clay’s patient. It waits for you to learn.", char = "joshua"},
                },
                late_body_111 = {
                    {text = "Alright, that’s your weather for tomorrow.", char = "joshua"},
                    {text = "Now let’s talk about foraging a bit, since some of you might be living off the land.", char = "joshua"},
                    {text = "First rule of foraging—know what you’re picking.", char = "joshua"},
                    {text = "Some berries feed you. Some berries send you to meet the sky spirits.", char = "joshua", effect = "FOR+1"},
                    {text = "Stick to things you can identify easy: blackberries, raspberries, dandelions.", char = "joshua"},
                    {text = "If you’re not sure, leave it be. Hunger’s better than poison.", char = "joshua"},
                },
                late_body_112 = {
                    {text = "That’s the forecast for tomorrow, friends.", char = "joshua"},
                    {text = "While you’re out there, might be a good time to practice some foraging.", char = "joshua"},
                    {text = "Look for wild greens—they grow near streams and shady spots.", char = "joshua"},
                    {text = "Things like sorrel and chickweed are edible, and they won’t taste half bad if you’re hungry.", char = "joshua"},
                    {text = "Stay away from shiny leaves. That’s usually nature’s way of saying 'don’t touch.'", char = "joshua", effect = "FOR+1"},
                    {text = "A little caution goes a long way out there.", char = "joshua"},
                },
                late_body_113 = {
                    {text = "And that’s it for the weather tonight.", char = "joshua"},
                    {text = "Now, for those of you gathering your meals from the forest—here’s a tip.", char = "joshua"},
                    {text = "Mushrooms are tricky. Some’ll feed you, some’ll put you six feet under.", char = "joshua"},
                    {text = "Stick to the ones you know, like chanterelles or puffballs.", char = "joshua"},
                    {text = "If you can’t name it, don’t eat it.", char = "joshua", effect = "FOR+1"},
                    {text = "Nature’s generous, but she’s not always friendly.", char = "joshua"},
                },
                late_body_114 = {
                    {text = "Forecast’s done for now, folks.", char = "joshua"},
                    {text = "Let’s talk survival for a moment—specifically, finding food when the cupboards are bare.", char = "joshua"},
                    {text = "Pine needles make a decent tea if you’re short on supplies.", char = "joshua"},
                    {text = "Just steep ‘em in hot water. Got some vitamin C in there, helps fight off scurvy.", char = "joshua"},
                    {text = "Avoid yew trees though—those needles’ll poison you.", char = "joshua", effect = "FOR+1"},
                    {text = "Stick to longleaf or white pine if you can.", char = "joshua"},
                },
                late_body_115 = {
                    {text = "That’s tomorrow’s weather, friends.", char = "joshua"},
                    {text = "Now, if you’re gonna be out there walking, keep your eyes on the ground too.", char = "joshua"},
                    {text = "Sometimes you’ll find nuts—walnuts, hickories, acorns.", char = "joshua"},
                    {text = "Acorns need to be boiled a few times to get the bitterness out.", char = "joshua", effect = "FOR+1"},
                    {text = "But once you do, they’re good calories.", char = "joshua"},
                    {text = "Nature leaves snacks everywhere if you know where to look.", char = "joshua"},
                },
                late_body_116 = {
                    {text = "Alright folks, weather’s checked and done.", char = "joshua"},
                    {text = "Let’s shift gears to foraging—'cause stores ain’t restocking anytime soon.", char = "joshua"},
                    {text = "Wild onions are easy to spot. They smell like onions, plain and simple.", char = "joshua"},
                    {text = "Look for long green shoots with little bulbs at the base.", char = "joshua", effect = "FOR+1"},
                    {text = "Don’t mix 'em up with lily of the valley though—that one’s poison.", char = "joshua"},
                    {text = "If it don’t smell like food, leave it be.", char = "joshua"},
                },
                late_body_117 = {
                    {text = "That’s your forecast wrapped up for tonight.", char = "joshua"},
                    {text = "Now let’s talk about staying fed without a supermarket.", char = "joshua"},
                    {text = "Wild carrots grow in fields and along fence lines.", char = "joshua"},
                    {text = "But careful—poison hemlock looks almost the same.", char = "joshua"},
                    {text = "Wild carrot roots smell like carrots. Hemlock smells like death.", char = "joshua", effect = "FOR+1"},
                    {text = "Trust your nose, folks.", char = "joshua"},
                },
                late_body_118 = {
                    {text = "Well, that’s the weather checked off.", char = "joshua"},
                    {text = "While we’re here, let me remind you—nature provides, if you respect it.", char = "joshua"},
                    {text = "Black walnuts are all over Kentucky if you know where to look.", char = "joshua", effect = "FOR+1"},
                    {text = "Crack 'em with a rock. They’re messy, but the meat inside is worth it.", char = "joshua"},
                    {text = "Don’t eat the outer green husk—that’ll stain your hands black.", char = "joshua"},
                    {text = "Good for dye, bad for dinner.", char = "joshua"},
                },
                late_body_119 = {
                    {text = "That’s the forecast for tomorrow, friends.", char = "joshua"},
                    {text = "If you’re heading out, take a basket or sack with you. Foraging’s half the battle now.", char = "joshua"},
                    {text = "Look for cattails if you’re near a marsh or pond.", char = "joshua"},
                    {text = "The roots are edible if you roast 'em. So are the green heads before they fluff out.", char = "joshua", effect = "FOR+1"},
                    {text = "Cattails are like the survival store of the swamp.", char = "joshua"},
                    {text = "Just keep your boots dry while you’re picking.", char = "joshua"},
                },
                late_body_120 = {
                    {text = "That wraps up your weather for the day.", char = "joshua"},
                    {text = "Now let’s shift to something practical—keeping your belly full.", char = "joshua"},
                    {text = "Wild mint is easy to find and makes for good tea.", char = "joshua"},
                    {text = "Smells fresh, grows in shady damp spots.", char = "joshua", effect = "FOR+1"},
                    {text = "I keep some drying here in the shack, love the smell.", char = "joshua"},
                }
            },
        },
        outro = {
        ...
        song = {
            ...
            song_boy_from_kentucky = {
                {text = "Alright folks, I got a little tune for you tonight.", char = "joshua"},
                {text = "It’s an old song from back when the worst thing I worried about was running out of gas.", char = "joshua"},
                {text = "They used to play this one at every get-together I remember.", char = "joshua"},
                {text = "<guitar strings squeak>", char = "sfx"},
                {text = "[img=music] Well I'm a boy from Kentucky... [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "[img=music] ...and because I'm unlucky... [img=music]", char = "joshua"},
                {text = "[img=music] I was sent all the way... [img=music]", char = "joshua"},
                {text = "[img=music] ...to Tennessee. [img=music]", char = "joshua"},
                {text = "[img=music] On her front porch I met her... [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "[img=music] and on her back porch I first kissed her. [img=music]", char = "joshua"},
                {text = "[img=music] But then I went home, cus of momma's ice tea... [img=music]", char = "joshua"},
                {text = "[img=music] Oh I'm a boy from Kentucky... [img=music]", char = "joshua"},
                {text = "[img=music] ... And yup, I'm unlucky... [img=music]", char = "joshua"},
                {text = "[img=music] Cos I never said: 'Bonnie... Marry me' [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "Heh. That one always gets me, folks.", char = "joshua"},
                {text = "Funny how we carry regrets longer than we carry groceries.", char = "joshua"},
                {text = "Anyway, thanks for sharing the night with me. Let’s all try to hold onto the sweet parts.", char = "joshua"},
            },
            song_truck_full_of_love = {
                {text = "Alright my friends, here’s one from the 80s.", char = "joshua"},
                {text = "This one’s for the road folks out there, or for anyone feeling a little highway in their heart tonight.", char = "joshua"},
                {text = "<guitar strings pluck softly>", char = "sfx"},
                {text = "[img=music] ♫ It gets pretty dark on those long lonely highways. ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "[img=music] ♫ Just me and my cabin with its nine pairs of wheels. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ I'm far from the cities, the middle of nowhere. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ But I know where to go with my truck full of love. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ I ain't never got lonely, ain't never got sad... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ 'Cause I know where I'm haulin' a truck full of love... ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "[img=music] ♫ I pull up to the stop. Fill up, get a burger. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ A woman in the diner comes over and smiles. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ 'Are you looking for love? You need a companion?' ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ 'Got one,' I say, and go to my truck full of love... ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "<guitar strings fade out>", char = "sfx"},
                {text = "Heh. Ain’t that something?", char = "joshua"},
                {text = "Sometimes love’s not a person—it’s just knowing where you belong.", char = "joshua"},
                {text = "Anyway, friends, keep your rigs steady and your hearts light.", char = "joshua"},
            },
            song_plum_outta_luck = {
                {text = "Alright folks, time for something a little sillier tonight.", char = "joshua"},
                {text = "Back in the day, songs like this got played at parties when the cider started flowing.", char = "joshua"},
                {text = "Remember—sometimes laughter’s the best survival tool we’ve got.", char = "joshua"},
                {text = "<guitar strings twang>", char = "sfx"},
                {text = "[img=music] ♫ Well hey now Buck, you're plum outta luck! ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "[img=music] ♫ Her fella's come home, and the window's stuck. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Y'all hear him coming up on those stairs... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ For five more seconds he'll be unawares! ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "[img=music] ♫ So then Buck you're plum outta luck! ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Next time think twice 'bout who you... ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "<soft chuckle, strings fade>", char = "sfx"},
                {text = "Hah! Ah, Buck never was the brightest lightbulb in the shed.", char = "joshua"},
                {text = "Folks, apocalypse or not—choices still have consequences.", char = "joshua"},
                {text = "Anyway, keep your windows loose and your hearts lighter.", char = "joshua"},
            },
            song_freddy_balloon = {
                {text = "Alright folks, here’s one from the weird corner of my songbook.", char = "joshua"},
                {text = "You meet all kinds in life. Some plant gardens, some build radios, and some…", char = "joshua"},
                {text = "Well, some folks tie scraps together and aim for the stars.", char = "joshua"},
                {text = "<guitar strings creak>", char = "sfx"},
                {text = "[img=music] ♫ We know a man called Freddy... ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "[img=music] ♫ ...and he's got a huge balloon. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ And it's gone so bloody big... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ We thought 'twas the falling moon! ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ We asked Freddy what's in it... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ He said mostly just hot air... ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "[img=music] ♫ ...and eggs and scraps of old cloth... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ ...and long strands of moldy hair. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Freddy's heading to Mars now... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ ...but he won't take us along. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ We'll miss him and his balloon... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ To Freddy, we sing this song! ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "<soft guitar pluck fades>", char = "sfx"},
                {text = "Heh… guess we all got our ways of escaping, huh?", char = "joshua"},
                {text = "Me, I stick with the radio. Freddy? Well, he had bigger plans.", char = "joshua"},
                {text = "Good luck out there, Freddy—wherever the wind took you.", char = "joshua"},
            },
            song_big_lonely_pool = {
                {text = "Alright folks, time for something from across the pond.", char = "joshua"},
                {text = "Back in the day, British rock bands used to put out songs like this when they were feeling cheeky.", char = "joshua"},
                {text = "It’s got that mix of blues, swagger, and… well, let’s just say poolside charm.", char = "joshua"},
                {text = "<guitar riff slides like a wet floor>", char = "sfx"},
                {text = "[img=music] ♫ YOWWW baby, you look cosy in that swimsuit! ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "[img=music] ♫ How about a swim in my big lonely pool? ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ The water's much warmer than it looks, baby... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Don't worry, I've been around this pool before.. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ YOWWW, come a little closer, get your feet wet! ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "[img=music] ♫ Dip a toe in the water - you might like it! ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ YOWWW, you won't drown baby, not while I'm around... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Don't worry about your hair, use my warm towel... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ YOWWW, come and dive in baby! The water's hot! ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "<guitar slides down like a lounge chair tipping over>", char = "sfx"},
                {text = "Heh! Well, ain’t that a time capsule?", char = "joshua"},
                {text = "Some songs are about love, some about life… and some are just about pools.", char = "joshua"},
                {text = "Anyway folks, stay safe out there—and if you do find a pool, make sure it isn’t occupied first.", char = "joshua"},
            },
            song_got_me_thinking = {
                {text = "Alright folks… sometimes the songs pick you, not the other way around.", char = "joshua"},
                {text = "This one… well, let’s just say it’s for those nights when the weight sits a little heavier.", char = "joshua"},
                {text = "If you’re out there listening, you’re not alone. Not really.", char = "joshua"},
                {text = "<guitar strings quietly hum>", char = "sfx"},
                {text = "[img=music] ♫ I'll tell you what it was that got me thinking. ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "[img=music] ♫ Hit me on the day when I quit drinking. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ My wife she's gone. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ My daughter said 'so long'. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ They left me all alone. ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "[img=music] ♫ And now I'm sinking... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ That's what it was that got me thinking. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ They left me all alone. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ And now yessir I'm sinking.. ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "<soft static hums as the guitar fades>", char = "sfx"},
                {text = "Mmm… yeah.", char = "joshua"},
                {text = "Some days you carry memories like a backpack full of bricks.", char = "joshua"},
                {text = "But we keep going. One step. Then another.", char = "joshua"},
                {text = "Thanks for sticking around with me tonight, friends.", char = "joshua"},
            },
            song_heading_for_the_heat = {
                {text = "Alright folks, let’s stir the pot a little tonight.", char = "joshua"},
                {text = "Sometimes the spirit’s willing but the mind wanders places it probably shouldn’t.", char = "joshua"},
                {text = "Here’s a tune about exactly that. Happens to the best of us.", char = "joshua"},
                {text = "<guitar strings hum with a sly slide>", char = "sfx"},
                {text = "[img=music] ♫ I used to be a good boy... ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "[img=music] ♫ Never did nobody wrong... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ But the first time I saw you... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ I cursed God and his poor son. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Yes I'm heading for the heat... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Each time you make my heart beat. ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "[img=music] ♫ Every time I see your grin... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Can't keep my mind off of sin... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ With a small swing of your hips... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ ... a big smile on your red lips... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ I'm going to the heat down below... ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "<guitar strum fades out>", char = "sfx"},
                {text = "Heh. Well, nobody said survival had to be boring.", char = "joshua"},
                {text = "Just remember, folks—temptation’s one thing, but staying alive’s another.", char = "joshua"},
                {text = "Keep your hearts warm and your feet cool out there.", char = "joshua"},
            },
            song_kelly_and_tom = {
                {text = "Alright folks, here’s one for the quiet hours.", char = "joshua"},
                {text = "Some songs ain’t just about love—they’re about the traps folks fall into chasing it.", char = "joshua"},
                {text = "We’ve all known a Kelly. Maybe some’ve been a Tom too. Life’s messy like that.", char = "joshua"},
                {text = "<soft guitar chords, bittersweet tone>", char = "sfx"},
                {text = "[img=music] ♫ Kelly worked at a diner, two bucks an hour... ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "[img=music] ♫ Tom charmed her away with a promise of gold... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ She woke next morning, he'd already left her... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Not even a note to remember him by... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Then he turns up again, many months later... ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "[img=music] ♫ His cap in his hand, a sad look in his eyes... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ 'I've changed, I swear! Life without you, I can't bear!' ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ 'I've changed, I swear! Need you more than I need air!' ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Kelly looks at the boss, takes off her apron... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Her heart full with another promise of hope... ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "<guitar fades into quiet picking>", char = "sfx"},
                {text = "Mmm. Hard not to feel that one, folks.", char = "joshua"},
                {text = "Love makes fools of all of us sometimes.", char = "joshua"},
                {text = "Be kind to each other. And be kind to yourself.", char = "joshua"},
            },
            song_loretta_trouble = {
                {text = "Alright folks, here’s one from the dusty side of the jukebox.", char = "joshua"},
                {text = "Now and then, old feelings sneak back up on you. But sometimes it’s best to leave the past where it is.", char = "joshua"},
                {text = "This one’s about a fella who forgot that lesson. Let’s hear how it worked out for him.", char = "joshua"},
                {text = "<guitar strings pluck>", char = "sfx"},
                {text = "[img=music] ♫ I hadn't seen Loretta in... ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "[img=music] ♫ ...close to thirty year. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ But I could still taste that kiss... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ ...and recall her rear. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Thought now she'd be kinda different. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ So today I checked her out. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ I stood outside her trailer... ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "[img=music] ♫ ...with a holler n' a shout. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ She asked what in hell I was doing. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Said I just woke her up. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Her husband got a shotgun, with a holler and a shout... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ ...chased me to the river and yessir he saw me out! ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "<guitar strums fade, a soft chuckle>", char = "sfx"},
                {text = "Heh! Well, folks, nostalgia’s nice… right up until the part where you’re dodging buckshot.", char = "joshua"},
                {text = "Maybe some memories are better kept in the mind and not in the front yard.", char = "joshua"},
                {text = "Anyway, take care of your hearts—and keep your feet ready to run.", char = "joshua"},
            },
            song_life_on_the_moon = {
                {text = "You know, folks… sometimes I like to imagine there’s still somewhere untouched by all this.", char = "joshua"},
                {text = "Maybe up there, past the clouds. A quiet little place with no walkers, no worries.", char = "joshua"},
                {text = "So here’s a tune for those of you looking up tonight, wondering what’s beyond all this mess.", char = "joshua"},
                {text = "[img=music] ♫ We landed on the moon, all's going fine. ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "[img=music] ♫ The soil is sandy, and there's lots of wine. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ The little green men are nice and polite. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ And the blue earth below blinks in the night. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ I see you down there, ever so tiny.. ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "[img=music] ♫ From my little cabin I see the sky. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Why don't you pop up, pay me a visit? ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Come up here with me and live on the moon. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Let's start living our lives oooooooooover again... ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "<guitar drifts off>", char = "sfx"},
                {text = "Mmm… yeah.", char = "joshua"},
                {text = "Funny thing is, part of me still thinks if I just keep broadcasting long enough, someone out there might answer.", char = "joshua"},
                {text = "Maybe it’ll be you. Or maybe it’ll be little green fellas.", char = "joshua"},
                {text = "Either way, friends, keep looking up. The sky’s still out there.", char = "joshua"},
            },
            song_mother_earth = {
                {text = "Alright, friends… this next one ain’t exactly my usual tune.", char = "joshua"},
                {text = "But sometimes a message comes along that’s too important to ignore, no matter the style.", char = "joshua"},
                {text = "We took a lot from this world. Might be time to sing about giving something back.", char = "joshua"},
                {text = "<guitar picks softly>", char = "sfx"},
                {text = "[img=music] ♫ Where have all the flowers gone? ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "[img=music] ♫ The flowing streams, once so clear... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ The forests we loved so dear... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Why do we kill Mother Earth? ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ She gives us food, all we need... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Asks for nothing in return... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Why do we kill Mother Earth? ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "[img=music] ♫ The farmland all turns to sand... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ The seas reach into the land... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Why do we kill Mother Earth? ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ The wars, murders, all our sins... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Our Mother Earth has no twin... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Why do we kill Mother Earth? ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "<guitar fades>", char = "sfx"},
                {text = "Yeah… heavy stuff, friends. But maybe the truth’s supposed to feel heavy.", char = "joshua"},
                {text = "If we ever get a second chance, let’s try not to mess it up the same way.", char = "joshua"},
                {text = "Till then, let’s at least tread lighter while we’re still here.", char = "joshua"},
            },
            song_reason_for_war = {
                {text = "Alright, my friends… this one’s from my younger days.", char = "joshua"},
                {text = "Back when the hair was longer, the protests louder, and the world just as broken as now.", char = "joshua"},
                {text = "Funny thing is, the tune’s still relevant. Maybe even more so.", char = "joshua"},
                {text = "<guitar strums slow, steady, like a march>", char = "sfx"},
                {text = "[img=music] ♫ What good reason is there for war? ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "[img=music] ♫ For murder, killing and mayhem? ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Meant to be a thing of the past... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Seems we're getting worse than ever. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ They send young boys to the jungle... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Tell them to figure it all out... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Boys they're shooting ain't much older. ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "[img=music] ♫ What good reason is there for war? ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ For murder, killing and mayhem? ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Ancient ideals? Old promises? ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Or for stuffing pockets of men? ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ They say they're evil, kill 'em all... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ But they scream and cry just like us... ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "<guitar fades, a long breath>", char = "sfx"},
                {text = "Hmph… some things don’t change, do they?", char = "joshua"},
                {text = "We were supposed to learn better after the last war. And the one before that.", char = "joshua"},
                {text = "Anyway, folks… stay kind. Stay human.", char = "joshua"},
            },
            song_kentucky_moonshine = {
                {text = "Alright, friends, time for a little Appalachian tradition.", char = "joshua"},
                {text = "Now, I ain’t saying you should go drinking things you find in a shed—but I ain’t saying you shouldn’t smile about it either.", char = "joshua"},
                {text = "This one’s about my Uncle Billy. Or, well… somebody’s Uncle Billy.", char = "joshua"},
                {text = "[img=music] ♫ My uncle Billy left me something in his will. ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "[img=music] ♫ An old tattered notebook, from his time in the hills. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Used to hide from the cops up there most of the time... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ ...brewing his special brand of Kentucky Moonshine! ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ In the notebook I found his famous recipe... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ So glad was I, started brewing right there and then... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ A pinch of whiskey, two quarts of runny old oil... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Half a pound of baked hops, ten pounds worth of good soil... ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "[img=music] ♫ Two ounces of tobacco, the milk of a cow.... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Five pounds of warm corn mash with six shakes of coal ash... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ And that was the recipe for Billy's moonshine. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Took a sip, just to taste it, but faded to black... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Now I'm up on a cloud with my uncle Billy... ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Playing my harp and brewing Kentucky Moonshine... ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "<guitar fades into light laughter>", char = "sfx"},
                {text = "Heh! Yep… I knew a few batches like that in my time.", char = "joshua"},
                {text = "Folks, if you do find Uncle Billy’s recipe out there—maybe skip the motor oil part, yeah?", char = "joshua"},
                {text = "Stay safe, keep warm, and don’t blow up your cabins.", char = "joshua"},
            },
            song_only_one_left = {
                {text = "Alright folks… here’s one for the empty hours.", char = "joshua"},
                {text = "Some nights, you look around and wonder if anyone’s still out there listening.", char = "joshua"},
                {text = "I’ll keep singing anyway. That’s just what I do.", char = "joshua"},
                {text = "<guitar strings echo softly>", char = "sfx"},
                {text = "[img=music] ♫ Where is everybody gone? ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "[img=music] ♫ An awful thing to occur. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Not even cats left to purr. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ The telly's totally blank. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ No customers in the bank. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ The schools are forgotten caves... ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "[img=music] ♫ Is there no-one left to save? ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ I'm the only one left. ♫ [img=music]", char = "joshua"},
                {text = "[img=music] ♫ Can't be the only one left... ♫ [img=music]", char = "joshua", effect = "UHP-1,BOR-1"},
                {text = "<guitar fades>", char = "sfx"},
                {text = "Hmm… yeah.", char = "joshua"},
                {text = "Funny thing about silence—it gets real loud after a while.", char = "joshua"},
                {text = "But I’ll keep talking. Just in case you’re still out there.", char = "joshua"},
            }
        },
        event = {
            event_raccoon_mic_theft = {
                {text = "Alright, friends, Joshua here again—comin’ at you live from the shack.", char = "joshua"},
                {text = "Hope you’ve all got your shelters locked up tight tonight. It’s a quiet one out here, for now.", char = "joshua"},
                {text = "Hold on… would you look at that—got myself a visitor at the window.", char = "joshua"},
                {text = "Hey there, little fella. Heh. You folks at home can’t see this, but I’ve got a raccoon staring right at me.", char = "joshua"},
                {text = "Hang on, lemme just crack this window—got some nuts here somewhere...", char = "joshua"},
                {text = "Alright, buddy, come on now… easy…", char = "joshua"},
                {text = "<clattering noises, shuffle sounds>", char = "sfx"},
                {text = "Whoa! Hey—HEY! That that’s my mic! Get back here!", char = "joshua"},
                {text = "<rustling, footsteps", char = "sfx"},
                {text = "You little bandit! Gimme that back!", char = "joshua"},
                {text = "<bzzzt>", char = "sfx"},
            },
            event_deer_in_garden = {
                {text = "Good evening out there, folks. It’s Joshua, checking in from the shack.", char = "joshua"},
                {text = "Hope you’re safe and sound tonight. Let’s see what kind of forecast we’ve got—", char = "joshua"},
                {text = "…Oh. Well now, would you look at that.", char = "joshua"},
                {text = "I’ve got a deer right outside the window here, just helpin’ itself to my garden.", char = "joshua"},
                {text = "Hey! Shoo! That’s not a salad bar for you, buddy!", char = "joshua"},
                {text = "<muffled rustling>", char = "sfx"},
                {text = "Ain’t that somethin’? Spent months growing these carrots, and now Bambi’s out here getting first dibs.", char = "joshua"},
                {text = "Alright, folks, give me just a second—I’ll be right back. Gonna go try diplomacy.", char = "joshua"},
                {text = "<shuffling noises>", char = "sfx"},
                {text = "<fzzzt>", char = "sfx"},
            },
            event_faceless_woman = {
                {text = "Hey there, folks… uh… Joshua here, comin’ at you live from… somewhere.", char = "joshua"},
                {text = "Now, listen close. I wasn’t gonna say this, but—", char = "joshua"},
                {text = "Did you know there’s a faceless woman who secretly lives in your home?", char = "joshua"},
                {text = "It’s true. She’s there right now. She’s always there. Just outta your sight.", char = "joshua"},
                {text = "I… uh… I don’t mean to alarm you folks, but you might wanna—hold on. Hold on a second.", char = "joshua"},
                {text = "<chair creaks, shuffling noises>", char = "sfx"},
                {text = "No ma’am, you can’t stay here. Please just… go on now.", char = "joshua"},
                {text = "Shoo. Shoo now. This ain’t your place neither.", char = "joshua"},
                {text = "<bzzzt>", char = "sfx"},
            },
            event_alpha_centauri_guest = {
                {text = "Well folks… tonight’s a special night. We’ve got ourselves a guest here on the station.", char = "joshua"},
                {text = "All the way from Alpha Centauri—say hello to our friend: Zorvak.", char = "joshua"},
                {text = "Now Zorvak, first question: How’s the weather out there in Centauri space?", char = "joshua"},
                {text = "<silence>", char = "sfx"},
                {text = "<bzzzt>", char = "sfx"},
                {text = "Uh-huh. Yeah, yeah… cosmic winds are nasty. That checks out.", char = "joshua"},
                {text = "But listen, Zorvak, I gotta tell you something.", char = "joshua"},
                {text = "Earth ain’t ready yet. It’s not safe down here. We’re still sorting out… well, everything.", char = "joshua"},
                {text = "You’re gonna have to wait another three hundred years before you can visit proper, okay?", char = "joshua"},
                {text = "Tell the others to just… hang tight in the stars awhile longer.", char = "joshua"},
                {text = "We’ll call you when we’re ready, buddy.", char = "sfx"},
                {text = "<fzzzt>", char = "sfx"},
            },
            event_spiritual_pass_out = {
                {text = "Mmm… folks, you ever think about how everything’s just… layers?", char = "joshua"},
                {text = "Like… we’re here in this world, but maybe there’s another one underneath.", char = "joshua"},
                {text = "And another one under that. Like… spiritual onions.", char = "joshua"},
                {text = "Peel it all back and maybe you get to… uh…", char = "joshua"},
                {text = "<fzzzt>", char = "sfx"},
                {text = "We’re all just stardust taking a nap...", char = "joshua"},
                {text = "<soft thump>", char = "sfx"},
                {text = "<snoring sounds>", char = "joshua"},
                {text = "Mm... pancaaaakes...", char = "joshua"},
                {text = "<bzzzzt>", char = "sfx"},
            },
            event_foraging_shroom_universe = {
                {text = "Good goodness out there, my friends. Hope you’re all safe and settled for the night.", char = "joshua"},
                {text = "Tonight I figured I’d teach y’all a little about foraging. Very special... froraging.", char = "joshua"},
                {text = "Now, there’s mushrooms you can eat, mushrooms you can cook…", char = "joshua"},
                {text = "And then there’s the SPECIAL shrooms. The kind that don’t fill your belly, but they sure fill your soul, open your chacras...", char = "joshua"},
                {text = "They got these little… uh… hats? Caps? Like tiny umbrellas for the forest floor.", char = "joshua"},
                {text = "If you look close, you can see the gills under there. Like… like the universe has gills, you know?", char = "joshua"},
                {text = "Everything’s just… soup, really. Stars, dirt, mushrooms, me, you… soup in different shapes.", char = "joshua"},
                {text = "And radiowaves... whoa... this one...", char = "joshua"},
                {text = "Just... uh... did you ever look up? There's a whole world up there... right where ceiling used to be... once... twice...", char = "joshua"},
            },
            event_hooded_figures = {
                {text = "Hey there, friends… Joshua here. Hope you’re all safe and warm tonight.", char = "joshua"},
                {text = "Uh… just gonna start with the weather in a second, but—", char = "joshua"},
                {text = "<bzzzt>", char = "sfx"},
                {text = "<whispers> Hold on. Folks, I… uh… I’m seein’ something out the window.", char = "joshua"},
                {text = "There’s… there’s people out there. Hooded folks. Can’t see their faces.", char = "joshua"},
                {text = "They’re just standin’ there. Starin’.", char = "joshua"},
                {text = "<soft rustling>", char = "sfx"},
                {text = "I… I think I better end the broadcast now. Just in case.", char = "joshua"},
                {text = "Stay quiet tonight, friends. Keep the lights low.", char = "joshua"},
            },
            event_sees_wife = {
                {text = "Hey there, friends… Joshua here.", char = "joshua"},
                {text = "Tonight’s one of those nights where the air’s too still, you know?", char = "joshua"},
                {text = "Wait. Hold on a second. I… I see someone.", char = "joshua"},
                {text = "It’s… that’s… that’s you...", char = "joshua"},
                {text = "But… I left you in the apartment. I-in the bedroom. I locked the door.", char = "joshua"},
                {text = "<chair creaks, shuffle sounds>", char = "sfx"},
                {text = "Honey? Hey—wait for me. I'm… I'm so sorry...", char = "joshua"},
                {text = "<sound of footsteps>", char = "sfx"},
            },
            event_radio_failure = {
                {text = "Good evening out there, folks. This is Joshua on the—", char = "joshua"},
                {text = "<fzzzzt> <bzzzzt>", char = "sfx"},
                {text = "—on the air tonight with your usual—uh—", char = "joshua"},
                {text = "<bzzzt>", char = "sfx"},
                {text = "Oh come on, not now...", char = "joshua"},
                {text = "<clatter of knobs, tapping sounds on the mic>", char = "sfx"},
                {text = "C’mon old girl, don’t give up on me tonight. We’ve got folks listening.", char = "joshua"},
                {text = "<fzzzt>", char = "sfx"},
                {text = "Hmm… battery line’s fine, cable’s… uh…", char = "joshua"},
                {text = "<BZZZZT>", char = "sfx"},
            },
            event_generator_flicker = {
                {text = "Alright friends, it’s Joshua here with tonight’s—", char = "joshua"},
                {text = "<bzzzt>", char = "sfx"},
                {text = "Oh no, not again…", char = "joshua"},
                {text = "<clank! buzzing>", char = "sfx"},
                {text = "Alright, folks, hang tight. Genny’s hiccuping. Let me just—", char = "joshua"},
                {text = "<fzzzt>", char = "sfx"},
                {text = "If you can still hear me, uh… check your own gas cans. These things—", char = "joshua"},
                {text = "<clicking noise, bzzt>", char = "sfx"},
            },
            event_antenna_issue = {
                {text = "Good evening, folks. Joshua here from the shack—", char = "joshua"},
                {text = "<high-pitched whine> <bzzzt>", char = "sfx"},
                {text = "Aw heck, is that the antenna again? Thought I patched that.", char = "joshua"},
                {text = "<fzzzt>", char = "sfx"},
                {text = "<bzzzt> ... stranded! Get ... <fzzzt> ... FUUUUCK! <bzzzzt>", char = "sfx"},
                {text = "<clatter of tools, distant metal tapping>", char = "sfx"},
                {text = "If you can hear this, uh—might be a short one tonight.", char = "joshua"},
                {text = "<fzzzt>", char = "sfx"},
            },
            event_distant_walker = {
                {text = "Hey there, friends. Joshua here, coming to you from the shack like usual.", char = "joshua"},
                {text = "Hope you’re safe tonight. Weather’s—uh—", char = "joshua"},
                {text = "<whispering> Hold on. I see someone… out there by the tree line.", char = "joshua"},
                {text = "They’re… yes... that's a shambler...", char = "joshua"},
                {text = "<soft creak of chair>", char = "sfx"},
                {text = "I’m just gonna get down low for a bit, folks. Keep my head below the window.", char = "joshua"},
                {text = "Maybe it’ll wander off…", char = "joshua"},
                {text = "<faint breathing>", char = "sfx"},
                {text = "<bzzzt>", char = "sfx"},
            },
            event_window_attack = {
                {text = "Hey there, folks. It’s Joshua again, comin’ to you live from—", char = "joshua"},
                {text = "<loud thud> <glass squeaks under pressure>", char = "sfx"},
                {text = "Aaah!", char = "joshua"},
                {text = "Oh… oh no. Someone’s at the window.", char = "joshua"},
                {text = "<wet dragging noises against glass> <moaning>", char = "sfx"},
                {text = "Window’s holdin’, but…", char = "joshua"},
                {text = "<gulps> Alright folks, I gotta step away. Gonna… lure this one off somewhere safe. Don’t want 'em hangin’ around here.", char = "joshua"},
                {text = "<chair scrapes>", char = "sfx"},
                {text = "<fzzzt>", char = "sfx"},
            }
        },
        death = {
